...
def procesadorVideo(state: State) -> State:
    ...
    # Obtener directorio donde está UAV_agent.py (MultiAgent)
    script_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Guardar frame para visualización en MultiAgent
    ...
    # Guardar codificación base64 en archivo txt en MultiAgent
